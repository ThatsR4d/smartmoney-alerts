...
Personal reference for maintaining and extending SmartMoneyAlerts.
...
```bash
python scrapers/sec_form4.py   # Test scraper
...
We primarily track `P` (purchases).
...
Key additions:
- `scrapers/congress.py`
- Days-to-disclosure tracking
- Politician name recognition
...
Key additions:
- `scrapers/hedge_funds.py`
- Quarter-over-quarter position changes
- Famous investor tracking (Buffett, Burry, etc.)
- New/exited position detection
